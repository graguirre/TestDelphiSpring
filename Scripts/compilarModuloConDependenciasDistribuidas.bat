...
CALL %RSVARS%
%MSBuild% %1 /t:Build /p:Config=Debug;Platform=Win32;DCC_DcuOutput=%OUTPUT_PATH%;DCC_UnitSearchPath=%SEARCH_PATH%;DCC_BplOutput=%OUTPUT_BPL_PATH%;DCC_DcpOutput=%OUTPUT_BPL_PATH%
